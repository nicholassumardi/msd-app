...
export default async function handler(
  ...
  try {
    ...
    switch (req.method) {
      ...
      case "PUT":
        response = await axiosInstance.put<Category>(
          `admin/master_data/job_family/category/update/${id}`,
          req.body
        );
      ...
      case "DELETE":
        response = await axiosInstance.delete<Category>(
          `admin/master_data/job_family/category/delete/${id}`
        );
