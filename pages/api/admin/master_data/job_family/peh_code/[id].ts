...
export default async function handler(
  ...
  try {
    ...
    switch (req.method) {
      case "GET":
        response = await axiosInstance.get<PehCode>(
          `admin/master_data/job_family/peh_code/show/${id}`
        );
      ...
      case "PUT":
        response = await axiosInstance.put<PehCode>(
          `admin/master_data/job_family/peh_code/update/${id}`,
          req.body
        );
      ...
      case "DELETE":
        response = await axiosInstance.delete<PehCode>(
          `admin/master_data/job_family/peh_code/delete/${id}`
        );
