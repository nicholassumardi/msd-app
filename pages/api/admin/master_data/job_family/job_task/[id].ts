    ...
    switch (req.method) {
      case "GET":
        response = await axiosInstance.get<JobTask>(
          `admin/master_data/job_family/job_task/show/${id}`
        );
      ...
      case "PUT":
        response = await axiosInstance.put<JobTask>(
          `admin/master_data/job_family/job_task/update/${id}`,
          req.body
        );
      ...
      case "DELETE":
        response = await axiosInstance.delete<JobTask>(
          `admin/master_data/job_family/job_task/delete/${id}`
        );
