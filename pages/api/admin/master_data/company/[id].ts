    ...
    switch (req.method) {
      case "GET":
        response = await axiosInstance.get<Company>(
          `admin/master_data/company/show/${id}`
        );
      ...
      case "PUT":
        response = await axiosInstance.put<Company>(
          `admin/master_data/company/update/${id}`,
          req.body
        );
      ...
      case "DELETE":
        response = await axiosInstance.delete<Company>(
          `admin/master_data/company/delete/${id}`
        );
