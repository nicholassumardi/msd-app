    ...
    switch (req.method) {
      case "GET":
        response = await axiosInstance.get<Certificate>(
          `admin/master_data/certificate/show/${id}`
        );
      ...
      case "PUT":
        response = await axiosInstance.put<Certificate>(
          `admin/master_data/certificate/update/${id}`,
          req.body
        );
      ...
      case "DELETE":
        response = await axiosInstance.delete<Certificate>(
          `admin/master_data/certificate/delete/${id}`
        );
