...
class TrainingServices extends BaseServices
{
    ...
    public function storeTraining(Request $request)
    {
        try {
            ...
            Training::create([
                ...
                'training_realisation_date'      => $request->training_realisation_date ? $this->parseDateUTC($request->training_realisation_date) : null,
                'training_duration'              => $request->training_duration,
                'ticket_return_date'             => $request->ticket_return_date ? $this->parseDateUTC($request->ticket_return_date) : null,
                'assessment_plan_date'           => $request->assessment_plan_date ? $this->parseDateUTC($request->assessment_plan_date) : null,
                'assessment_realisation_date'    => $request->assessment_realisation_date ?  $this->parseDateUTC($request->assessment_realisation_date) : null,
    ...
    public function getDataTrainingPagination(Request $request)
    {
        ...
        $totalCount = ceil($training->count() / $size);
        $training = $training
            ->skip($start)
            ->take($size)
            ->get();
