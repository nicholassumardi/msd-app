...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: <IconDatabaseSmile className="-ml-1" />,
        label: "Master Data",
        route: "#",
        children: [
          {
            ...
            route: "#",
            grandchildren: [
              { label: "Area & Companies", route: "/master_data/companies" },
              {
                label: "Departments & Plants",
                route: "/master_data/departments",
              },
            ],
          },
          {
            label: "Job Family",
            route: "/master_data/job_family",
            // grandchildren: [
            //   {
            //     label: "Category & PEH Codes",
            //     route: "/master_data/job_family/category",
            //   },
            //   // { label: "PEH Codes", route: "/master_data/job_family/peh_code" },
            //   {
            //     label: "Job Descriptions",
            //     route: "/master_data/job_family/job_description",
            //   },
            //   { label: "Job Tasks", route: "/master_data/job_family/job_task" },
            //   { label: "IKWS", route: "/master_data/job_family/ikws" },
            // ],
          },
          { label: "Certificates", route: "/master_data/certificates" },

          { label: "Classifications", route: "/master_data/classifications" },
        ],
      },
      {
        icon: (
        ...
        label: "Employee Centre",
        route: "/employee",
      },
      // {
      //   icon: <IconTopologyRing2 className="-ml-1" />,
      //   label: "Structure",
      //   route: "/structure",
      // },
      {
        icon: <IconFiles className="-ml-1" />,
        label: "IKW, Job Desc, Job Task",
        route: "/ikws",
      },
      {
        icon: <IconFiles className="-ml-1" />,
      ...
      {
        icon: <IconFileCertificate className="-ml-1" />,
        label: "Training",
        route: "/training",
      },
      {
        icon: <IconMedal className="-ml-1" />,
        label: "Evaluation",
        route: "/evaluation",
      },
    ],
  },
  {
    ...
    menuItems: [
      ...
      {
        icon: <IconLayoutKanban className="-ml-1" />,
        label: "Kanban",
        route: "/kanban",
      },
      {
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* SIDEBAR HEADER */}
        <div className="flex items-center justify-center gap-2 px-3 py-0.5 lg:py-0.5">
          <Link href="/">
            <Image
              width={150}
              height={10}
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* Sidebar Menu */}
          <nav className="mt-3 px-4 py-1 lg:mt-1 lg:px-1">
