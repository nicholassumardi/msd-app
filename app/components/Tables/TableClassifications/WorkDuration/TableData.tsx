...
import FormWorkDuration from "./Form";
...
const TableDataWorkDuration = () => {
  ...
  const table = useMantineReactTable({
    ...
    renderTopToolbarCustomActions: ({ table }) => (
      ...
      >
        <FormWorkDuration getData={getData} setIsLoading={setIsLoading} />
      ...
      <>
        <Box className="flex flex-nowrap gap-2">
          ...
          <ButtonDelete
            ...
            getData={getData}
            setIsLoading={setIsLoading}
            params="type=deleteWorkingDurationClassification"
          />
        </Box>
      </>
    ),
...
export default TableDataWorkDuration;
