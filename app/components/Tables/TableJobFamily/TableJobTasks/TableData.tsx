...
import { JobTask } from "../../../../../pages/api/admin/master_data/job_family/job_task";
import FormJobTask from "./Form";
import ButtonExport from "@/components/common/ButtonExport";

const columns: MRT_ColumnDef<JobTask>[] = [
  {
...
const TableData = () => {
  ...
  const handleExportRows = (rows: MRT_Row<JobTask>[]) => {
  ...
  const table = useMantineReactTable({
    ...
    renderTopToolbarCustomActions: ({ table }) => (
      ...
      >
        <FormJobTask getData={getData} setIsLoading={setIsLoading} />
