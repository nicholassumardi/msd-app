...
const TableDataCategory = () => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        "/api/admin/master_data/job_family/category?type=showPagination",
        {
          params: {
  ...
  const table = useMantineReactTable({
    ...
    renderTopToolbarCustomActions: ({ table }) => (
      ...
      >
        <FormCategory getData={getData} setIsLoading={setIsLoading} />
        <ButtonExport {...{ table, handleExport }} />
        <ImportDropzone url="/api/admin/import/category" />
      </Box>
    ),
...
export default TableDataCategory;
