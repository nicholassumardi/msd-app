...
class CreateUserStructureMappingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_structure_mappings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('user_structure_mappings');
    }
}
